...
% Optionally wrap expression if second argument is not empty
%\newcommand*\OptionalWrap[2]{\ensuremath{\ifstrempty{#2}{#1}{\left(#1\right)}}}
% Optionally add subscript, if it is not empty
\newcommand*\OptionalSubscript[1][]{\ifstrempty{#1}{}{_{#1}}}
% Optionally add superscript, if it is not empty
\newcommand*\OptionalSuperscript[1][]{\ifstrempty{#1}{}{^{#1}}}
%% Optionally add superscript, if it is not empty
